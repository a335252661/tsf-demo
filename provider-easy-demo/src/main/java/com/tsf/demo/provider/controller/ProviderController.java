...
//        String result = "provider-easy-demo : request param: " + param + ", response from " +
//                providerNameConfig.getName()+" , spring.application.name: "+ CurrentName +", 当前服务器ip："+ IpUntil.getIp();
//        LOG.info("provider-demo -- provider config name: [" + providerNameConfig.getName() + ']');
//        LOG.info("provider-demo -- response info: [" + result + "]");

        return "provider-demo-18088";
    }
