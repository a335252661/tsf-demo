...
public class TsfUserDao {
    ...
    public String queryDM(final String userName) throws Exception {
        try {
//            String sql = "SELECT `user_token` FROM `tsf_user` WHERE `user_name` = '" + userName + "'";
    ...
    public String queryOracle(final String userName) throws Exception {
        try {
//            String sql = "SELECT `user_token` FROM `tsf_user` WHERE `user_name` = '" + userName + "'";
            String sql = "select address from T_USER where id = 1";
